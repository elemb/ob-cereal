...
You write commands (Forth, I²CDriver (https://github.com/jamesbowman/i2cdriver) in =#+BEGIN_SRC cereal= blocks → Org sends them over real serial → you get the reply as =#+RESULTS:=.
